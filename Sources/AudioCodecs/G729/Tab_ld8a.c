...
FFLOAT hamwindow[L_WINDOW] = {        /* hamming-cosine window */
(F)0.08000000,
(F)0.08005703,
(F)0.08022812,
(F)0.08051321,
...
FFLOAT lwindow[MP1] = {          /* lag window for correlations */
WNC,
(F)0.99889028,
(F)0.99556851,
(F)0.99005681,
...
FFLOAT grid[GRID_POINTS+1] = { /* grid for evaluating  Chebychev polynomials */
(F)0.9997559,
(F)0.9980267,
(F)0.9921147,
(F)0.9822872,
...
FFLOAT pred[4] = {               /* MA prediction coeff */
(F)0.68,
(F)0.58,
(F)0.34,
(F)0.19
...
FFLOAT b100[3] = {(F)0.93980581E+00, (F)-0.18795834E+01,  (F)0.93980581E+00};
FFLOAT a100[3] = {(F)1.00000000E+00,  (F)0.19330735E+01, (F)-0.93589199E+00};

/* filter coefficients (fc = 140 Hz)  */

FFLOAT b140[3] = {(F)0.92727435E+00, (F)-0.18544941E+01, (F)0.92727435E+00};
FFLOAT a140[3] = {(F)1.00000000E+00, (F)0.19059465E+01, (F)-0.91140240E+00};
