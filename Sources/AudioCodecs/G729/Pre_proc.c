...
static FFLOAT x0, x1;         /* high-pass fir memory          */
// static FFLOAT y1, y2;         /* high-pass iir memory          */
static FFLOAT z1, z2;         /* high-pass iir memory          */
...
)
{
  ...
  for(i=0; i<lg; i++)
  {
    ...
    y0 = z1*a140[1] + z2*a140[2] + x0*b140[0] + x1*b140[1] + x2*b140[2];
