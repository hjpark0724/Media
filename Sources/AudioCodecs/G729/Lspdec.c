...
static void lsp_iqua_cs( int prm[], FFLOAT lsp[], int erase);
...
static FFLOAT prev_lsp[M];            /* previous LSP vector         */
...
static void lsp_iqua_cs(
 ...
 FFLOAT  lsp_q[],        /* output: Quantized LSP parameters  */
...
void d_lsp(
    ...
    FFLOAT   lsp_q[],    /* output: decoded lsp             */
