...
static void cor_h(
     ...
     FFLOAT *rr          /* (o) :Correlations of H[]         */
);
static int d4i40_17_fast(/*(o) : Index of pulses positions.               */
  FFLOAT dn[],           /* (i) : Correlations between h[] and Xn[].       */
  FFLOAT *rr,            /* (i) : Correlations of impulse response h[].    */
  FFLOAT h[],            /* (i) : Impulse response of filters.             */
  FFLOAT cod[],          /* (o) : Selected algebraic codeword.             */
  FFLOAT y[],            /* (o) : Filtered algebraic codeword.             */
...
{
  int i, index;
  static FFLOAT Dn[L_SUBFR]; /* "static" to avoid stack overflow on PC */
  static FFLOAT rr[DIM_RR];  /* "static" to avoid stack overflow on PC */
...
{
  FFLOAT *rri0i0, *rri1i1, *rri2i2, *rri3i3, *rri4i4;
  FFLOAT *rri0i1, *rri0i2, *rri0i3, *rri0i4;
  FFLOAT *rri1i2, *rri1i3, *rri1i4;
  FFLOAT *rri2i3, *rri2i4;

  FFLOAT *p0, *p1, *p2, *p3, *p4;

  FFLOAT *ptr_hd, *ptr_hf, *ptr_h1, *ptr_h2;
  FFLOAT cor;
...
)
{
  ...
  FFLOAT psk, ps, ps0, ps1, ps2, sq, sq2;
  FFLOAT alpk, alp, max;
  FFLOAT s, alp0, alp1, alp2;
  FFLOAT *p0, *p1, *p2, *p3, *p4;

  FFLOAT sign_dn[L_SUBFR], sign_dn_inv[L_SUBFR], *psign;
  FFLOAT tmp_vect[NB_POS];
  ...
  FFLOAT  *ptr_rri0i3_i4;
  FFLOAT  *ptr_rri1i3_i4;
  FFLOAT  *ptr_rri2i3_i4;
  FFLOAT  *ptr_rri3i3_i4;
