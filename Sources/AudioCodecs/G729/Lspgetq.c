...
static void lsp_stability(
 FFLOAT  buf[]           /*in/out: LSP parameters  */
);
...
void lsp_get_quant(
 ...
 FFLOAT  fg[][M],        /*input : MA prediction coef.          */
 FFLOAT  freq_prev[][M], /*input : previous LSP vector          */
...
*/
static void lsp_prev_compose(
  FFLOAT lsp_ele[],             /* (i) Q13 : LSP vectors                 */
  FFLOAT lsp[],                 /* (o) Q13 : quantized LSP parameters    */
  FFLOAT fg[][M],               /* (i) Q15 : MA prediction coef.         */
  FFLOAT freq_prev[][M],        /* (i) Q13 : previous LSP vector         */
  FFLOAT fg_sum[]               /* (i) Q15 : present MA prediction coef. */
)
{
   int j, k;
...
void lsp_prev_extract(
  FFLOAT lsp[M],                /* (i) Q13 : unquantized LSP parameters  */
  FFLOAT lsp_ele[M],            /* (o) Q13 : target vector               */
  FFLOAT fg[MA_NP][M],          /* (i) Q15 : MA prediction coef.         */
  FFLOAT freq_prev[MA_NP][M],   /* (i) Q13 : previous LSP vector         */
  FFLOAT fg_sum_inv[M]          /* (i) Q12 : inverse previous LSP vector */
)
{
  int j, k;
...
void lsp_prev_update(
  FFLOAT lsp_ele[M],             /* input : LSP vectors           */
  FFLOAT freq_prev[MA_NP][M]     /* input/output: previous LSP vectors  */
)
{
  int k;
